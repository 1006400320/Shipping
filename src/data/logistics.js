...
export const shipmentTasks = [
  ...
  },
  {
    ...
    feeStatus: '待物流上传',
    operationRecords: [
      { time: '2026-02-25 09:00', operatorOrg: '捷顺', operator: '陈丽', action: '创建送货单' },
      { time: '2026-02-25 10:15', operatorOrg: '捷顺', operator: '陈丽', action: '完善送货信息' },
      { time: '2026-02-25 14:20', operatorOrg: '捷顺', operator: '赵刚', action: '打印单据' },
      { time: '2026-02-26 09:10', operatorOrg: '捷顺', operator: '王敏', action: '完成拣配' },
      { time: '2026-02-26 09:45', operatorOrg: '捷顺', operator: '刘洋', action: '完成抽检' },
      { time: '2026-02-26 10:25', operatorOrg: '捷顺', operator: '张三', action: '完成封箱贴单' },
      { time: '2026-02-26 13:50', operatorOrg: '跨越速运', operator: '李强', action: '确认车辆到仓' },
      { time: '2026-02-26 14:30', operatorOrg: '跨越速运', operator: '李强', action: '交接装车' }
    ],
    tone: 'green'
  },
  {
    ...
    feeStatus: '待预约送货',
    operationRecords: [
      { time: '2026-02-25 09:30', operatorOrg: '捷顺', operator: '陈丽', action: '创建送货单' },
      { time: '2026-02-25 11:10', operatorOrg: '捷顺', operator: '陈丽', action: '完善送货信息' },
      { time: '2026-02-25 15:35', operatorOrg: '捷顺', operator: '赵刚', action: '打印单据' },
      { time: '2026-02-26 09:20', operatorOrg: '捷顺', operator: '王敏', action: '完成拣配' },
      { time: '2026-02-26 10:05', operatorOrg: '捷顺', operator: '刘洋', action: '完成抽检' },
      { time: '2026-02-26 10:35', operatorOrg: '捷顺', operator: '张三', action: '完成封箱贴单' },
      { time: '2026-02-26 11:00', operatorOrg: '顺丰速运', operator: '张三', action: '确认离厂' },
      { time: '2026-02-26 15:40', operatorOrg: '顺丰速运', operator: '李强', action: '发起预约送货' },
      { time: '2026-02-26 16:05', operatorOrg: '顺丰速运', operator: '李强', action: '联系收货人' },
      { time: '2026-02-26 16:20', operatorOrg: '顺丰速运', operator: '李强', action: '发送签收码' }
    ],
    tone: 'green'
  },
  {
